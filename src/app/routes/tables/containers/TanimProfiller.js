          ...
          <div className="row">
            <article className="col-sm-12">
              ...
              <JarvisWidget editbutton={false} color="darken">
                <header><span className="widget-icon"> <i className="fa fa-table"/> </span> <h2>Profiller</h2></header>
                <div>
                  <div className="widget-body no-padding">
                  <Datatable
                    options={{
                      ajax: 'assets/api/tables/data-profiller.json',
                      columns: [{data: "id"}, {data: "name"}, {data: "status"}, {data: "timestamp"}]
                    }}
